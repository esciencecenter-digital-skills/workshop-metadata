...
To participate in this workshop you must have Docker installed. Each participant will be asked to show their installation is in working order in a one-on-one session in the week preceding the actual workshop. During this session, instructors and/or helpers can help with installation issues that might arrise.
Docker
